$jdk_version = '12'
$build = '33'
$id = "312335d836a34c7c8bba9d963e26dc23"
...
function chocolatey-install($params) {
    ...
    $checksum = '81D9DD46777E49C58FD5A83D5C76757AC4C35FE9C0F4AA5277F547A33A64A95F'
    $checksumType = 'sha256'

    Get-ChecksumValid -File "$jdk_file" `
                      -Checksum "$checksum" `
    ...
    $install_options += '"'
    Install-ChocolateyInstallPackage 'jdk12' 'exe' $install_options $jdk_file
}
